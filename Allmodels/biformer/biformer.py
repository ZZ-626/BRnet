...
class BiFormer(nn.Module):
    def __init__(self, depth=[3, 4, 8, 3], in_chans=3, num_classes=1000, embed_dim=[64, 128, 320, 512],
        ...
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other models_cls
        ...
        # Ensure qk_dims is valid by replacing None with a default value
        qk_dims = [dim if dim is not None else head_dim for dim in qk_dims]
